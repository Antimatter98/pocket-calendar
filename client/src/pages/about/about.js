        ...
        <div align="left" className="privacy-background about-content">
          <div>
            <div>
              ...
              <p>
                This WebApp schedules unread items from the users' pocket
                account to his/her Google Calendar so that they can check them
                out their own convenience!
              </p>
              <p>
                A small bunch of articles are scheduled everyday for you, based
                on your preferred daily reading time.
              </p>
            </div>
          </div>
          <div className>
